...
Y.Skin.renderers.dial = function (skin) {
    ...
    return {
        ...
        ringGradient:               '-moz-linear-gradient(-45deg, rgba(255,255,255, 0.1) 0%, rgba(255,255,255,0)'
                                    +' 39%, rgba(0,0,0,0) 40%, rgba(0,0,0, 0.2) 100%)',
        centerButtonBackgroundColor:    space.block.normal.background,
        centerButtonText:               space.block.normal.text.normal,
        centerButtonGradient:           '-moz-radial-gradient(30% 30% 0deg, circle farthest-side, rgba(255,255,255, 0.3)'
                                        +' 24%, rgba(255,255,255, 0) 41%, rgba(0,0,0, 0) 42%, rgba(0,0,0, 0.2) 83%) repeat scroll 0 0 transparent',
